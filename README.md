...
| [fast-p](https://github.com/bellecp/fast-p) | Quickly find a pdf whose _contents_ match a pattern, among a messy collection of PDFs | 
...
| [broot](https://github.com/Canop/broot) | A new way to see and navigate directory trees with a customizable and interactive UI. Whale watching mode and sorting by number of files are especially useful.      |

Optional, yet interesting, additions:

| Tool                | Description                                                                                   |
|---------------------|-----------------------------------------------------------------------------------------------|
| [starship](https://github.com/starship/starship) | The minimal, blazing-fast, and infinitely customizable prompt for any shell. Consider `.promptrc` from this repo as a simple alternative/addition.           |
...
| [Oh my zsh](https://ohmyz.sh/)| A powerful and feature-rich shell with extensive configuration options. Powerful but can be heavy.                      |
